...
public class App extends Application
{
    ...
    private List<Step> initializeSteps()
    {
        ...
        StepView view2 = new StepView(controller2);
        ...
        Step step1 = new Step("Load Image", StepType.INITIAL, view1);
        Step step2 = new Step("Pre-Processing", StepType.STANDARD, view2);
        Step step3 = new Step("Reconstruct", StepType.STANDARD, view3);
        Step step4 = new Step("Compress", StepType.STANDARD, view4);
        Step step5 = new Step("Final Result", StepType.FINAL, view5);
    ...
    {
        Image icon = new Image(App.class.getResourceAsStream("assets/icon_placeholder.png"));
